...
echo "[1/5] Preparing C1 comprehensive configuration"

cp "$SCRIPT_DIR"/config/scraping/comprehensive/* "$REPO_ROOT/scraping/"

cp "$SCRIPT_DIR"/config/port_scanning/comprehensive/* "$REPO_ROOT/port_scanning/"

cp "$SCRIPT_DIR/config/zstun_probing/comprehensive/stun_pkts.conf" "$REPO_ROOT/zstun_probing/scripts/stun/stun_pkts.conf"
